...
if (profile != null) {
	...
	profile.addEventListener("submit", e => {
		...
		let flag = true;
		/* loginMemberProfileImg : myPage-profile.html 하단에 script를 
								   이용하여 타임리프로 선언해둔 변수*/
...
/*  [input type="file" 사용 시 유의 사항]
 ...
 3. 선택된 파일 정보를 저장하는 속성은
   ...
   ────────────────────────────────────────────────────────────────
   	e.target <input type=​"file" name=​"profileImg" id=​"imageInput" accept=​"image/​*">​
	myPage.js:213 e.target.value C:\fakepath\HoonBal.png
	myPage.js:217 e.target.files FileList {0: File, length: 1}
	myPage.js:221 e.target.files[0] 
